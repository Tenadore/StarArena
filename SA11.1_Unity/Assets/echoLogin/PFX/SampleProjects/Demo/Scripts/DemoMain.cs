...
public class DemoMain : MonoBehaviour 
{
	...
	//==================================================================================================
	public static void StartShieldHit ( int ishockid, int ibuldgeid, float ivx, float ivy )
	{
		_shockWave.DistortionCenter ( 0, ishockid, ivx, ivy );
		_shockWave.DistortionCenter ( 0, ibuldgeid, ivx, ivy );
		_shockWave.Start();
		_shieldHit.Start();
	}
